...
epatterns.append(r'([A-Za-z0-9.]+)\s*&#[A-Za-z0-9.]+;\s*([A-Za-z0-9._]+)\.edu')
epatterns.append(r'([A-Za-z.]+)\s+@\s+([A-Za-z.]+)\.[A-Za-z]+')
epatterns.append(r'([A-Za-z.]+)@([A-Za-z.]+)\.[A-Za-z]+')
epatterns.append(r'([a-z.]+)\b[<][a-zA-Z&; ]+[>].?@([a-z.]+).edu')
epatterns.append(r'([A-Za-z0-9.]+)\s*\([\s*A-Za-z0-9.&;#]*["|;}]@([A-Za-z0-9._]+)\.edu')
...
epatterns.append(r'([A-Za-z0-9.]+)\s*at\s*([A-Za-z0-9.]+)\.EDU')
epatterns.append(r'([a-zA-Z0-9]+)\s*[<][a-zA-Z0-9 .]+[>]\s*([a-zA-Z0-9.]+)([a-zA-Z0-9.]+)edu')
...
ppatterns.append(r'(?:[(])([0-9]{3})(?:[)])[ ]*([0-9]{3})-([0-9]{4})')
...
if __name__ == '__main__':
    ...
    main('c:/Users/kastu/Desktop/Syracuse/Spring22/IST664-NLP/Assignments/Assignment2/ContactFinder/data/dev', 'c:/Users/kastu/Desktop/Syracuse/Spring22/IST664-NLP/Assignments/Assignment2/ContactFinder/data/devGOLD')
